...
public class DiseaseAllergyController {
    ...
    @GetMapping
    public ResponseEntity<DiseaseAllergyRes> getDiseaseAllergyList(@RequestParam Long profileId){
        DiseaseAllergyRes res = diseaseAllergyService.getDiseaseAllergyList(profileId);
        return BaseResponse.ok(res);
    }

    @PostMapping("/edit")
    public ResponseEntity<DiseaseAllergyRes> editDiseaseAllergy(@RequestBody DiseaseAllergyEditReq req, @RequestParam Long profileId){
